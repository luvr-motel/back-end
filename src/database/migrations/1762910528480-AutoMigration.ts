...
export class AutoMigration1762910528480 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "itemlocacao" ("itemlocacao_id" SERIAL NOT NULL, "itemlocacao_qtde" integer NOT NULL, "itemlocacao_valor" float, "itemlocacao_inclusao" TIMESTAMP NOT NULL DEFAULT now(), "itemlocacao_exclusao" TIMESTAMP, "comanda_id" integer NOT NULL, "locacao_id" integer NOT NULL, "produto_id" integer NOT NULL, "motel_id" integer NOT NULL, CONSTRAINT "PK_itemlocacao_id" PRIMARY KEY ("itemlocacao_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "itemlocacao" ADD CONSTRAINT "FK_itemlocacao_comanda" FOREIGN KEY ("comanda_id") REFERENCES "comanda"("comanda_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "itemlocacao" ADD CONSTRAINT "FK_itemlocacao_locacao" FOREIGN KEY ("locacao_id") REFERENCES "locacao"("locacao_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "itemlocacao" ADD CONSTRAINT "FK_itemlocacao_produto" FOREIGN KEY ("produto_id") REFERENCES "produto"("produto_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "itemlocacao" ADD CONSTRAINT "FK_itemlocacao_motel" FOREIGN KEY ("motel_id") REFERENCES "motel"("motel_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
