...
export class AutoMigration1762263718926 implements MigrationInterface {
    name = 'AutoMigration1762263718926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pagamento_forma" ("pagamentoForma_id" SERIAL NOT NULL, "pagamentoForma_descricao" character varying NOT NULL, "pagamentoForma_contaDestino" character varying NOT NULL, "pagamentoforma_inclusao" TIMESTAMP NOT NULL DEFAULT now(), "pagamentoforma_exclusao" TIMESTAMP, "motel_id" integer, CONSTRAINT "PK_eb1fd8103cea1621a486c5cb8e2" PRIMARY KEY ("pagamentoForma_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "locacao_tipo" ("locacaoTipo_id" SERIAL NOT NULL, "locacaoTipo_descricao" character varying NOT NULL, "locacaoTipo_inclusao" TIMESTAMP NOT NULL DEFAULT now(), "locacaoTipo_exclusao" TIMESTAMP, CONSTRAINT "PK_553686ca72e6db0134c8a031f7e" PRIMARY KEY ("locacaoTipo_id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."motel_motel_ativo_enum" AS ENUM('ATIVO', 'INATIVO')`);
        await queryRunner.query(`CREATE TABLE "motel" ("motel_id" SERIAL NOT NULL, "motel_descricao" character varying(255), "motel_endereco" character varying(255), "motel_email" character varying(255), "motel_cnpj" character varying(18) NOT NULL, "motel_ativo" "public"."motel_motel_ativo_enum" NOT NULL DEFAULT 'ATIVO', "motel_inclusao" TIMESTAMP NOT NULL DEFAULT now(), "motel_exclusao" TIMESTAMP, CONSTRAINT "UQ_358a85ecd9d01d3a1b3326c2955" UNIQUE ("motel_cnpj"), CONSTRAINT "PK_107367ee395cdac03f03ee48ca0" PRIMARY KEY ("motel_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "usuario" ADD CONSTRAINT "FK_659579ebaa0dc57858708ac17f4" FOREIGN KEY ("motel_id") REFERENCES "motel"("motel_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."motel_motel_ativo_enum"`);
